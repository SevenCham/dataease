<template>
  <div class="pwd-body">
    <div class="pwd-wrapper">
      <div class="pwd-content" v-if="showPassword">
...
export default {
  ...
  methods: {
    ...
    getPassword() {
      //从window.parent中的 DATAEASE_PASSWORD对象中获取密码
      const password = window.parent.DATAEASE_PASSWORD;
      if (password) {
    ...
    refresh() {
      ...
      this.$refs.pwdForm.validate((valid) => {
        ...
        const param = this.user
          ...
          : { password: this.form.password, resourceId: this.resourceId };
...
.pwd-body {
  ...
  user-select: none;
  color: #3d4d66;
  font: normal 12px Helvetica Neue, Arial, PingFang SC, Hiragino Sans GB,
    Microsoft YaHei, 微软雅黑, Heiti, 黑体, sans-serif;
